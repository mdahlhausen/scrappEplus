  ...
  def OsLib_HVAC.createVRFAirConditioners(model, runner, options, parameters)
    ...
    model.getBuildingStorys.sort.each do |building_story|
      ...
      # create new air loop if story contains primary zones
        ...
        vrfAirConditioner.setMasterThermostatPriorityControlType("ZonePriority")
        ...
        #include better VRF curves
        # VRFHeatCapFT,            !- Heating Capacity Ratio Modifier Function of Low Temperature Curve Name
        vrfHeatCapFTCurve = OpenStudio::Model::CurveBiquadratic.new(model)
        vrfHeatCapFTCurve.setCoefficient1Constant(1.014599599)
        vrfHeatCapFTCurve.setCoefficient2x(-0.002506703)
        vrfHeatCapFTCurve.setCoefficient3xPOW2(-0.000141599)
        vrfHeatCapFTCurve.setCoefficient4y(0.026931595)
        vrfHeatCapFTCurve.setCoefficient5yPOW2(1.83538E-06)
        vrfHeatCapFTCurve.setCoefficient6xTIMESY(-0.000358147)
        vrfHeatCapFTCurve.setMinimumValueofx(15)
        vrfHeatCapFTCurve.setMaximumValueofx(27)
        vrfHeatCapFTCurve.setMinimumValueofy(-20)
        vrfHeatCapFTCurve.setMaximumValueofy(15)
        vrfAirConditioner.setHeatingCapacityRatioModifierFunctionofLowTemperatureCurve(vrfHeatCapFTCurve)
        # VRFHeatCapFTBoundary,    !- Heating Capacity Ratio Boundary Curve Name
        vrfHeatCapFTBoundaryCurve = OpenStudio::Model::CurveCubic.new(model)
        vrfHeatCapFTBoundaryCurve.setCoefficient1Constant(-7.6000882)
        vrfHeatCapFTBoundaryCurve.setCoefficient2x(3.05090016)
        vrfHeatCapFTBoundaryCurve.setCoefficient3xPOW2(-0.1162844)
        vrfHeatCapFTBoundaryCurve.setCoefficient4xPOW3(0.0)
        vrfHeatCapFTBoundaryCurve.setMinimumValueofx(15)
        vrfHeatCapFTBoundaryCurve.setMaximumValueofx(27)
        vrfAirConditioner.setHeatingCapacityRatioBoundaryCurve(vrfHeatCapFTBoundaryCurve)
        # VRFHeatCapFTHi,          !- Heating Capacity Ratio Modifier Function of High Temperature Curve Name
        vrfHeatCapFTHiCurve = OpenStudio::Model::CurveBiquadratic.new(model)
        vrfHeatCapFTHiCurve.setCoefficient1Constant(1.161134821)
        vrfHeatCapFTHiCurve.setCoefficient2x(0.027478868)
        vrfHeatCapFTHiCurve.setCoefficient3xPOW2(-0.00168795)
        vrfHeatCapFTHiCurve.setCoefficient4y(0.001783378)
        vrfHeatCapFTHiCurve.setCoefficient5yPOW2(2.03208E-06)
        vrfHeatCapFTHiCurve.setCoefficient6xTIMESY(-6.8969E-05)
        vrfHeatCapFTHiCurve.setMinimumValueofx(15)
        vrfHeatCapFTHiCurve.setMaximumValueofx(27)
        vrfHeatCapFTHiCurve.setMinimumValueofy(-10)
        vrfHeatCapFTHiCurve.setMaximumValueofy(15)
        vrfAirConditioner.setHeatingCapacityRatioModifierFunctionofHighTemperatureCurve(vrfHeatCapFTHiCurve)
        # VRFHeatEIRFT,            !- Heating Energy Input Ratio Modifier Function of Low Temperature Curve Name
        vrfHeatEIRFTCurve = OpenStudio::Model::CurveBiquadratic.new(model)
        vrfHeatEIRFTCurve.setCoefficient1Constant(0.87465501)
        vrfHeatEIRFTCurve.setCoefficient2x(-0.01319754)
        vrfHeatEIRFTCurve.setCoefficient3xPOW2(0.00110307)
        vrfHeatEIRFTCurve.setCoefficient4y(-0.0133118)
        vrfHeatEIRFTCurve.setCoefficient5yPOW2(0.00089017)
        vrfHeatEIRFTCurve.setCoefficient6xTIMESY(-0.00012766)
        vrfHeatEIRFTCurve.setMinimumValueofx(15)
        vrfHeatEIRFTCurve.setMaximumValueofx(27)
        vrfHeatEIRFTCurve.setMinimumValueofy(-20)
        vrfHeatEIRFTCurve.setMaximumValueofy(12)
        vrfAirConditioner.setHeatingEnergyInputRatioModifierFunctionofLowTemperatureCurve(vrfHeatEIRFTCurve)
        # VRFHeatEIRFTBoundary,    !- Heating Energy Input Ratio Boundary Curve Name
        vrfHeatEIRFTBoundaryCurve = OpenStudio::Model::CurveCubic.new(model)
        vrfHeatEIRFTBoundaryCurve.setCoefficient1Constant(-7.6000882)
        vrfHeatEIRFTBoundaryCurve.setCoefficient2x(3.05090016)
        vrfHeatEIRFTBoundaryCurve.setCoefficient3xPOW2(-0.1162844)
        vrfHeatEIRFTBoundaryCurve.setCoefficient4xPOW3(0.0)
        vrfHeatEIRFTBoundaryCurve.setMinimumValueofx(-20)
        vrfHeatEIRFTBoundaryCurve.setMaximumValueofx(15)
        vrfAirConditioner.setHeatingEnergyInputRatioBoundaryCurve(vrfHeatEIRFTBoundaryCurve)
        # VRFHeatEIRFTHi,          !- Heating Energy Input Ratio Modifier Function of High Temperature Curve Name
        vrfHeatEIRFTHiCurve = OpenStudio::Model::CurveBiquadratic.new(model)
        vrfHeatEIRFTHiCurve.setCoefficient1Constant(2.504005146)
        vrfHeatEIRFTHiCurve.setCoefficient2x(-0.05736767)
        vrfHeatEIRFTHiCurve.setCoefficient3xPOW2(4.07336E-05)
        vrfHeatEIRFTHiCurve.setCoefficient4y(-0.12959669)
        vrfHeatEIRFTHiCurve.setCoefficient5yPOW2(0.00135839)
        vrfHeatEIRFTHiCurve.setCoefficient6xTIMESY(0.00317047)
        vrfHeatEIRFTHiCurve.setMinimumValueofx(15)
        vrfHeatEIRFTHiCurve.setMaximumValueofx(27)
        vrfHeatEIRFTHiCurve.setMinimumValueofy(-20)
        vrfHeatEIRFTHiCurve.setMaximumValueofy(15)
        vrfAirConditioner.setHeatingEnergyInputRatioModifierFunctionofHighTemperatureCurve(vrfHeatEIRFTHiCurve)
        # HeatingEIRLowPLR,        !- Heating Energy Input Ratio Modifier Function of Low Part-Load Ratio Curve Name
        heatingEIRLowPLRCurve = OpenStudio::Model::CurveCubic.new(model)
        heatingEIRLowPLRCurve.setCoefficient1Constant(0.1400093)
        heatingEIRLowPLRCurve.setCoefficient2x(0.6415002)
        heatingEIRLowPLRCurve.setCoefficient3xPOW2(0.1339047)
        heatingEIRLowPLRCurve.setCoefficient4xPOW3(0.0845859)
        heatingEIRLowPLRCurve.setMinimumValueofx(0)
        heatingEIRLowPLRCurve.setMaximumValueofx(1)
        vrfAirConditioner.setHeatingEnergyInputRatioModifierFunctionofLowPartLoadRatioCurve(heatingEIRLowPLRCurve)
        # HeatingEIRHiPLR,         !- Heating Energy Input Ratio Modifier Function of High Part-Load Ratio Curve Name
        heatingEIRHiPLRCurve = OpenStudio::Model::CurveQuadratic.new(model)
        heatingEIRHiPLRCurve.setCoefficient1Constant(2.4294355)
        heatingEIRHiPLRCurve.setCoefficient2x(-2.235887)
        heatingEIRHiPLRCurve.setCoefficient3xPOW2(0.8064516)
        heatingEIRHiPLRCurve.setMinimumValueofx(0.0)
        heatingEIRHiPLRCurve.setMaximumValueofx(1.5)
        vrfAirConditioner.setHeatingEnergyInputRatioModifierFunctionofHighPartLoadRatioCurve(heatingEIRHiPLRCurve)
        # HeatingCombRatio,        !- Heating Combination Ratio Correction Factor Curve Name
        heatingCombRatioCurve = OpenStudio::Model::CurveLinear.new(model)
        heatingCombRatioCurve.setCoefficient1Constant(0.96034)
        heatingCombRatioCurve.setCoefficient2x(0.03966)
        heatingCombRatioCurve.setMinimumValueofx(1.0)
        heatingCombRatioCurve.setMaximumValueofx(1.5)
        heatingCombRatioCurve.setMinimumCurveOutput(1.0)
        heatingCombRatioCurve.setMaximumCurveOutput(1.023)
        vrfAirConditioner.setHeatingCombinationRatioCorrectionFactorCurve(heatingCombRatioCurve)
        # VRFCPLFFPLR,             !- Heating Part-Load Fraction Correlation Curve Name
        vrfCPLFFPLRCurve = OpenStudio::Model::CurveQuadratic.new(model)
        vrfCPLFFPLRCurve.setCoefficient1Constant(0.85)
        vrfCPLFFPLRCurve.setCoefficient2x(0.15)
        vrfCPLFFPLRCurve.setCoefficient3xPOW2(0)
        vrfCPLFFPLRCurve.setMinimumValueofx(0.0)
        vrfCPLFFPLRCurve.setMaximumValueofx(1.0)
        vrfCPLFFPLRCurve.setMinimumCurveOutput(0.85)
        vrfCPLFFPLRCurve.setMaximumCurveOutput(1.0)
        vrfAirConditioner.setHeatingPartLoadFractionCorrelationCurve(vrfCPLFFPLRCurve)
          ...
          vrf_fan = vrf_terminalUnit.supplyAirFan()
          vrf_fan = vrf_fan.to_FanOnOff.get
          #runner.registerWarning("#{vrf_fan.class}")
          vrf_fan.setPressureRise(120.00)
